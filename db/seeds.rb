...
authors = User.create!([
  {name: 'Andor', photo:'https://whatsondisneyplus.com/wp-content/uploads/2022/09/andor-avatar.png', bio: 'Rebel fighter from Kenari.An accomplished Alliance Intelligence officer with combat field experience, Captain Cassian Andor commands respect from his Rebel troops with his ability to keep a cool head under fire and complete his missions with minimal resources.', email: 'cassiandor@rebels.com', password: 'cassiandor', password_confirmation: 'cassiandor'},
  {name: 'Luthen Rael', photo: 'https://i0.wp.com/imgs.hipertextual.com/wp-content/uploads/2022/10/Andor_Luthen-Rael.png?fit=2554,1642&quality=60&strip=all&ssl=1', bio: 'A mysterious man with an eye for valuable finds, Luthen Rael will go to great lengths and traverse the galaxy to locate the pieces he needs to achieve his goals. A chameleon in dress and identity, Luthen capably hides behind countless faces and identities as the need arises.', email: 'luthenrael@rebels.com', password: 'luthen', password_confirmation: 'luthen'},
  ...
  {name: 'Sergeant Linus Mosk', photo: 'https://pbs.twimg.com/media/FdTUjpUWQAEzO0n.jpg:large', bio: 'Sergeant Linus Mosk was a human male who served in Preox-Morlana\'s Pre-Mor Enforcement. Following the murder of two Preox-Morlana employees in 5 BBY, Mosk was summoned to Corporate Security Headquarters on the planet Morlana One to meet with Deputy Inspector Syril Karn.', email: 'linusmosk@empire.com', password: 'linusmosk', password_confirmation: 'linusmosk'},
  {name: 'Maarva Andor', photo: 'https://www.starwarsnewsnet.com/wp-content/uploads/2022/09/Maarva_Poster_Andor-691x1024.jpg', bio: 'A member of the Daughters of Ferrix, Maarva is revered for the sharpness of her mind and firmness of her spirit. Despite the years and her failing health, she has a strong independent streak in her, something she shares with her adopted son, Cassian.', email: 'maarva@rebels.com', password: 'maarva', password_confirmation: 'maarva'},
  {name: 'Saw Gerrera', photo: 'https://cdn.theplaylist.net/wp-content/uploads/2021/06/14175118/forest-whitaker-andor-rogue-one.jpg', bio: 'A battered veteran of the Clone Wars as well as the ongoing rebellion against the Empire, Saw Gerrera leads a band of Rebel extremists. Saw has lost much in his decades of combat, but occasional flashes of the charismatic and caring man he once was shine through his calloused exterior', email: 'sawgerrera@rebels.com', password: 'sawgerrera', password_confirmation: 'sawgerrera'},
  {name: 'John Doe', bio: 'I am the default username everywhere, beware I don\'t hunt your dreams', email: 'john@doe.com', password: 'johndoe', password_confirmation: 'johndoe', role: 'admin'}
])
